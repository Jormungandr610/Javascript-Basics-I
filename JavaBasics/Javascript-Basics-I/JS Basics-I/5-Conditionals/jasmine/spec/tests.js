describe('needsLicense', () => {
  it('requires a license for a car', () => {
    expect(needsLicense('car')).toBe(true);
  });

  it('requires a license for a truck', () => {
    expect(needsLicense('truck')).toBe(true);
  });

  it('does not require a license for a bike', () => {
    expect(needsLicense('bike')).toBe(false);
  });

  it('does not require a license for a stroller', () => {
    expect(needsLicense('stroller')).toBe(false);
  });

  it('does not require a license for an e-scooter', () => {
...
describe('chooseVehicle', () => {
  ...
  it('correctly recommends the first option', () => {
  ...
  it('correctly recommends the second option', () => {
